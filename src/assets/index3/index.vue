    ...
    <div class="container">
        ...
        <van-form >
            ...
            <van-cell label="聊天方式"  class="touLie">
                <template #title>
                    <span class="custom-title"  style="margin-right:50px">聊天方式</span>{{liaoTianangShi}}
                </template>
...
<script>
    ...
    export default {
        ...
        methods : {
            ...
            //聊天方式转换
            fangShiFormat: function(){
                for(var i=0;i<this.listFangShiLie.length;i++){
                    if(this.pdemandData.pFangShi==this.listFangShiLie[i].label){
                        this.liaoTianangShi=this.listFangShiLie[i].value
                    }
                }
            },
